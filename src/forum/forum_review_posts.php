            ...
            while ($posts_info = mysqli_fetch_array($topic_res)) {
                ...
                "<tr>   
                    <form method=post action=\"$_SERVER[PHP_SELF]\">     
                        ...
                        <td><input type=\"submit\" class=\"green-button mt-0 mb-0\" style=\"border-radius: 5px;!important\" value=\"Accept\" name=\"accepted\"></td>
                        <td><input type=\"submit\" class=\"red-button mt-0 mb-0\" style=\"border-radius: 5px;!important\" value=\"Reject\" name=\"rejected\"></td>
                    </form>
                </tr>";
            }
        }
