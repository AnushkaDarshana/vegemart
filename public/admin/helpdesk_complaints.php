    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="tab has-text-centered">
                <button id="tab-button" style="background-color: #D7DBDD;" onClick="location.href='./helpdesk_complaints.php';">Home</button>
                <button id="tab-button" onClick="location.href='./helpdesk_resolved.php';">My Posts</button>
            </div>
