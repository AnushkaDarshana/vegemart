        ...
        <div class="row">
            <div class="columns group mt-1 mb-1">
                ...
                <div class="column is-6 mt-0">
                    ...
                    <br>
                    <a id="ab" href="https://localhost/vegemart/public/products.php"><i class="fa fa-hand-o-left pr-1" style="font-size:22px; font-weight:500; color:#3e8e41;"></i>Continue shopping</a>
                    <br>
                </div>
                <div class="column is-3 mt-0"></div>
            </div>
