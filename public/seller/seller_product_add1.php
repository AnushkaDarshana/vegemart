                            ...
                            <div class="columns group">
                                <div class="column is-12 pl-2 pr-2">
                                    ...
                                    <div class="input-row">                                              
                                        ...
                                        <input type="number" class="input-box" id="quantity" name="quantity" placeholder="Quantity" min="250" step="50" required/><br>
                                        
                                    </div>
                                    <div class="input-row">                                               
                                        <label for="minPrice">Minimum price per unit(Rs):</label>
                                        <input type="number" class="input-box" id="minPrice" name="minPrice" placeholder="Minimum Price" min="30" required/><br>
                                    </div>
